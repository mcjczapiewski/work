...
with io.open(r'D:\_MACIEK_\python_proby\p33\zapis.txt', 'r', encoding = 'utf-8') as sciezki:
    for line in sciezki:
        ...
        sciezka = regex.sub('(^.+\t.+)(040706_5.....)(.*)', '\g<1>'+nato+'\g<3>', sciezka)
        nowe.append(sciezka)
...
##        if not any(fname == obreb for fname in os.listdir(r'I:\INOWROCŁAW\DANE_IRON_MOUNTAIN\20190614\ZADANIE 2\KRUSZWICA')):
##            print(obreb)
