...
for subdir, dirs, files in os.walk(sprawdzanie):
    ...
    # rozbija sciezke do folderu i bierze tylko ostatni
    # czlon jako numer operatu
                ...
                for subdir, dirs, files in os.walk(sprawdzanie):
                    ...
                    for file in sorted(files):
                        ...
                        if file.lower().endswith((".jpg", ".jpeg")):
                            ...
                            # do pamieci, zeby przy kolejnych plikach znow
                            # sprawdzic
                            else:
                                ...
                                # jesli pierwsze i drugie byly juz identyczne
                                # do innego pliku tzn. ze wzgledem siebie tez
                                # sa identyczne wiec nie porownuje ich ponownie
                                elif (
                                    pierwsze in nie_powtarzaj
                                    and drugie in nie_powtarzaj
                                ):
                                    continue
