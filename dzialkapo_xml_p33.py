...
####                if any(regex.match('^.+dzialkaPrzed.+04.+', line) for line in oxml) and not any(regex.match('^.+dzialkaPo.+04.+', line) for line in oxml):
...
####                                else:
####                                    nxml.write(line)
####                    with io.open(r'D:\_MACIEK_\python_proby\p33\dzialka_po_xml\zmienionexml.txt', 'a', encoding = 'utf-8') as zmienione:
####                        zmienione.write(xml+'\n')
