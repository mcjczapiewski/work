...
for subdir, dirs, files in os.walk(tusapdfy):
    ...
    for file in files:
        ...
        # wszystkie nazwy plikow do wielkiej
        # litery w celu ujednolicenia - tylko w skrypcie,
        # nie zmienia nazw plikow
        nowy = file.upper()
        if nowy.endswith(".PDF"):
            ...
            for subdir, dirs, _ in os.walk(tusawkt):
                ...
                if nrope2 == nrope:
                    ...
                    # sprawdza czy .WKT dla tego operatu istnieje,
                    # jesli tak, to probuje go kopiowac
                    if os.path.exists(wktpath):
                        ...
                        # jesli plik w tej lokalizacji o takiej nazwie
                        # juz istnieje, to idzie do kolejnego pliku PDF
                        ...
                        # jesli nie, to probuje utworzyc dany plik
                            ...
                            # w razie bledu, wypisze sciezke pliku,
                            # ktory sie nie utworzyl
                            except:
                    ...
                    # jesli [nr_ope].WKT nie istnieje
                        ...
                        with open(bledny, "a") as bl:
                            bl.write(
                                "Dla danego operatu nie istnieje \
                                    plik .wkt:\t"
                                + folderpdf
                                + "\n"
                            )
