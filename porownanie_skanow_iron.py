        ...
        if nrope2 == nrope:
            ...
            if zdjecia != porow_zdj:
                with open(bledny, 'a') as bl:
                    bl.write('ich\t' + folder_name + '\t' + str(zdjecia) + '\tnasze\t')
                    bl.write(subdir + '\t' + str(porow_zdj) + '\n')
                ...
                with open(bledny, 'a') as bl1:
                    bl1.write('ich z przejściową\t' + folder_name + '\t' + str(zdjecia))
                    bl1.write('\tnasze z przejściową\t' + subdir + '\t' + str(porow_zdj) + '\n')
