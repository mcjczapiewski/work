            ...
            for entry in os.scandir(subdir):
                if entry.name.endswith('.ppm'):
                    try:
                        ...
                        with open(bledy_druku, 'a') as bd:
                                bd.write('PermissionError, możliwe że pliki ppm do usunięcia ręcznie w folderze!:\t'+subdir+'\n')
                        break
                    except:
                        with open(bledy_druku, 'a') as bd:
                                bd.write('Możliwe, że pliki ppm do usunięcia ręcznie w folderze!:\t'+subdir+'\n')
                        break
