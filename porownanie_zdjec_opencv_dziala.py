                            ...
                            try:
                                if original.shape == image_to_compare.shape:
                                    ...
                                    if (cv2.countNonZero(b) == 0 and cv2.countNonZero(g) == 0
                                        ...
                                        print(os.path.join(folder_glowny, pierwotne) + ' and '
                                              + os.path.join(subdir, porownane) + ' are completely Equal')
                                    else:
                                        print(os.path.join(folder_glowny, pierwotne) + '\t'
                                              + os.path.join(subdir, porownane) + '\tnot the same')
                                ...
                                print(os.path.join(folder_glowny, pierwotne) + ' Nie porownano '
