...
stad = r"I:\INOWROCŁAW\DANE_IRON_MOUNTAIN\20190614\DĄBROWA BISKUPIA\metadane_gogolewski"  # noqa
...
for subdir, dirs, files in os.walk(stad):
    ...
    if not any(fname.upper().endswith(".PDF") for fname in os.listdir(subdir)):
        ...
        if os.path.exists(docelowy):
            ...
            with open(
                r"D:\_MACIEK_\python_proby\brak_odpowiednika_folderu.txt", "a"
            ) as brak:
                brak.write(glowny + "\n")
