...
for subdir, dirs, files in os.walk(tusapdfy):
    ...
    for file in files:
        ...
        # wszystkie nazwy plikow do wielkiej litery w celu ujednolicenia - tylko w skrypcie,
            ...
            for subdir, dirs, _ in os.walk(tusawkt):
                ...
                if nrope2 == nrope:
                    ...
                    if os.path.exists(wktpath):
                        ...
                        # jesli plik w tej lokalizacji o takiej nazwie juz istnieje, to idzie
                        # do kolejnego pliku PDF
