...
import os, re, shutil, datetime, ctypes
...
print('\nPodaj ścieżkę, w której znajduje się plik lista.txt (plik_zrodlowy TABULATOR folder_docelowy; kodowanie pliku txt w ANSI):')
plik_lista = input()
