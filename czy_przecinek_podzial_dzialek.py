        ...
        try:
            with io.open(opis, "r", encoding="utf-8") as f:
                ...
                for line in f:
                    ...
                    # szuka linijki zaczynajacej sie od cyfry i z
                    # grupami podzialowymi linijka musi posiadac
                    # podzial na te same numery w liczniku
                    if re.match(r"^[0-9].+?\|(.*?)/.*?,\1", line):
                        ...
                        # jesli jest jakis / to sprawdza czy jest o 1 mniej,
                        # niz / bo inaczej jest jakis blad z dzialkami
                        if slash > 0:
                            if not przecinek == slash - 1:
                                with io.open(
                                    ...
                                    bl.write(
                                        "Błąd w działkach przed podziałem.\t"
                                        + str(linia)
                                        + "\t"
                                        + subdir
                                        + "\n"
            ...
            with open(opis, "r") as f:
                ...
                for line in f:
                    ...
                    # szuka linijki zaczynajacej sie od cyfry i
                    # z grupami podzialowymi linijka musi posiadac
                    # podzial na te same numery w liczniku
                    if re.match(r"^[0-9].+?\|(.*?)/.*?,\1", line):
