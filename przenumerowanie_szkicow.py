...
zmienione = sciezka + '\\' + os.path.basename(os.path.normpath(sciezka)) + '_zmienione_'\
    + czasstart.strftime('%Y-%m-%d') + '.txt'
        ...
        if file.endswith('.jpg' or '.JPG' or '.jpeg' or '.JPEG'):
            ...
            if fnmatch.fnmatch(file, '00_*'):
                ...
                if newname == file:
                    ...
                    # jesli podczas proby okazalo sie, ze taka nazwa juz istnieje, to tworzy
                    # kolejna nazwe dodajac do numeru strony 'a'
                ...
                with open(bledny, 'a') as bl:
                    bl.write('Nie zmieniono nazwy, bo nie odpowiada wzorcowi:\t')
