...
plikwynik = sciezka+'\\'+os.path.basename(os.path.normpath(sciezka))+'_wynik_'+czasstart.strftime('%Y-%m-%d')+'.txt'
...
for subdir, dirs, files in os.walk(pierwotne):
    ...
    for file in natsorted(files):
        ...
        lista.add(file)
    if lista:
        porownaj = subdir.replace(r'I:\skany\N', r'P:\cyfryzacja_powiat_wloclawski\WERSJA_NA_DYSKU\N')
