...
# root jesli chcemy wrzucac plik pythona do foleru, w ktorym jest folder do sprawdzenia
# rootdir = 'PARTIA 1.0'
...
bledny = sciezka+'\\'+wynikowy+'_BLEDY_zmien_dpi_'+czasstart.strftime('%Y-%m-%d')+'.txt'
...
input('\nPlików do przekonwertowania: '+str(alllines)+'\n\nWciśnij ENTER aby kontynuować...')
...
with open(textfile, 'r') as otxt:
    for line in otxt:
        ...
        # jak sie nie uda to wpisuje zciezke problematycznego pliku do pliku tekstowego
        except:
