                ...
                for subdir, dirs, files in os.walk(sprawdzanie):
                    ...
                    for file in sorted(files):
                        ...
                        # przy kolejnych plikach znow sprawdzic
                            ...
                            # jesli pierwsze i drugie byly juz identyczne do innego pliku
                            # tzn. ze wzgledem siebie tez sa identyczne wiec nie porownuje ich ponownie
                                ...
                                #  1) Check if 2 images are equals
                                    ...
                                    # jesli nie to nie
                                                ...
                                                with open(plikrozne, 'a') as wynik:
                                                    wynik.write('\tróżnią się\t' + pierwsze + '\t')
                                                    wynik.write(drugie + '\n')
